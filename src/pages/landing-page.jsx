export const LandingPage = () => {
    return (
        <>
            <div>
                <div className="w-full relative    min-h-[calc(100vh-20%)] flex  bg-gradient-to-b from-custom-gray-900 via-custom-gray-800 to-custom-gray-600">
                    <div className="absolute w-full h-full  pointer-events-none overflow-hidden -z-1">
                    ...
                    <div className="min-h-full w-full flex items-center justify-start">
                        <div className="mx-auto w-full max-w-[1240px] px-6 lg:px-10 py-6 lg:py-10 pt-10 lg:pt-24 lg:py-36">
                            <div className="w-full text-center z-1 md:w-3/5 md:mx-auto lg:mx-0 ltr:lg:text-left rtl:lg:text-right lg:w-2/5">
                                <h1 className="text-dark-100 min-h-[127px] font-bold text-displaySmall lg:text-displayLarge">The best <nobr>all-in-one</nobr> bot<br /> for Discord</h1>
                                <p className="text-dark-300 text-base mt-7 mb-10 whitespace-pre-line">Mee6 is a complete Discord bot, easy-to-use, that millions of Discord servers worldwide trust to manage, entertain, and grow their community.</p>
                                <div className="flex flex-col md:flex-row justify-center lg:justify-start items-stretch gap-4 max-w-[168px] lg:max-w-none m-auto">
                                    <button className="relative flex overflow-hidden shrink-0 rounded-lg transition-all duration-200 items-center  gap-1.5 bg-brand-default text-dark-100 hover:bg-brand-hover active:bg-brand-default active:bg-opacity-40 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-brand-default undefined text-base px-6 py-3">
                                        <div className="flex flex grow justify-center max-w-full"><span className="transition-all duration-200 whitespace-nowrap text-ellipsis overflow-hidden block w-full shrink-0 text-center">
                            ...
                            <div className=" absolute  bottom-0 right-0 h-full md:w-1/2 translate-x-6 translate-y-6 md:translate-y-0 md:translate-x-0 md:absolute ltr:right-0 rtl:left-0 rtl:-scale-x-[1] bottom-0 flex items-end ltr:justify-end rtl:justify-start pointer-events-none -z-1">
